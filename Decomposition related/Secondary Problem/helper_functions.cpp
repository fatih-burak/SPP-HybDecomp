...
void printInfo(const string& pathAndFileout, const Solution& sol, const string& filein) {
	...
	file << fixed << setprecision(2) << filein << "\t" << sol.opt << "\t" << sol.timeT << "\t" << sol.iLB << "\t" << sol.LB << "\t" << sol.Ncalls << "\t" << sol.Ncuts << "\t" << sol.NfailSl << "\t" << sol.tLBinc << "\t" << sol.tInitSol << "\t" << sol.tFeasSl << "\t" << sol.NbMaxInfesSL << "\t" << sol.NbMaxInfesSL2 << "\t" << sol.tSlave << "\t" << sol.tRealSl << "\t" << sol.tmis << "\t" << sol.tmisLR << "\t" << sol.tmisO << "\t" << sol.tmisR << "\t" << sol.NmisLR << "\t" << sol.NmisLR_o << "\t" << sol.NmisO << "\t" << sol.NmisR << "\t" << sol.NmisFull << "\t" << sol.DmisLR << "\t" << sol.DmisLR_o << "\t" << sol.DmisO << "\t" << sol.DmisR << "\t" << sol.tCutCheck << "\t" << sol.NelCut << "\t" << sol.timeP << "\t" << sol.tLB << "\t" << sol.tLB1 << "\t" << sol.tLB2 << "\t" << sol.tLB3 << "\t" << sol.vLB1 << "\t" << sol.vLB2 << "\t" << sol.vLB3 << endl;
	file.close();
}
