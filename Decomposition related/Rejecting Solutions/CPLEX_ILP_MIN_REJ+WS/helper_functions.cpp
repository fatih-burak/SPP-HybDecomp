...
void printInfo(const string& pathAndFileout, const Solution& sol, const string& filein) {
	...
	file << fixed << setprecision(2) << filein << "\t" << sol.opt << "\t" << sol.timeT <<
		"\t" << sol.iLB << "\t" << sol.LB << "\t" << sol.UB <<
		"\t" << sol.Ncalls << "\t" << sol.Ncuts << "\t" << sol.NfailSl <<
		"\t" << sol.tLBinc << "\t" << sol.tInitSol << "\t" << sol.tSlave <<
		"\t" << sol.higherCuts << "\t" << sol.t_higherCuts << 
		"\t" << sol.higherFeas << "\t" << sol.t_higherFeas <<
		"\t" << sol.higherInfeas << "\t" << sol.t_higherInfeas <<
		"\t" << sol.higherSkip << "\t" << sol.t_higherSkip
		<< endl;
	file.close();
}
