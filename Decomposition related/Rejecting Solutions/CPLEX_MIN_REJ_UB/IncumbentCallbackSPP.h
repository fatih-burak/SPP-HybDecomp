...
public:
	...
	vector<vector<int>> solution;
	// Constructor
	IncumbentCallbackSPP(IloEnv env, Instance& instS, Solution& solS, const vector<vector<IloIntVar>>& xS, const IloIntVar zS, const vector<vector<bool>>& NPsS);  // Initialize inst as a reference;
