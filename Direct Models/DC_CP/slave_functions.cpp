...
vector<bool> MIS_R(const vector<vector<int>>& items_slave, const vector<vector<int>>& bins, const int& H, vector<bool>& deleted) {
	...
	random_shuffle(remainingItems.begin(), remainingItems.end());
